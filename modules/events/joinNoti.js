...
module.exports.run = async function({ api, event, Users }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		api.changeNickname(`[ ${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "Bot của Cánh Cụt" : global.config.BOTNAME}`, threadID, api.getCurrentUserID());
...
\n◆━━━━━━━━━━━━━◆\n📝Nhập .ad sẽ có thông tin của adminbot và nhập .callad + lỗi để báo cáo admin\n📌Liên hệ khi cần thiết\n◆━━━━━━━━━━━━━◆\nThis bot made by Cánh Cụt. Thank you for using\nXin cảm ơn đã đọc...UwU\n© Admin: Yuki Kiriha`, threadID);
	}
	else {
		try {
